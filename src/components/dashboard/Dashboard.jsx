...
const Dashboard = () => {
  return (
    <div className="bg-black">
      <div className="flex justify-between items-center text-center gap-16 md:gap-0">
        <p className="text-white font-semibold text-xl md:text-2xl">Dashboard</p>
        ...
        <div className="mt-8 cursor-pointer">
          <div className="border-2 border-dashed rounded border-zinc-600 w-full h-64 bg-zinc-900 flex justify-center text-center">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="text-neutral-300 text-sm md:text-md mt-4">Tap to upload your Image</p>
              <p className="text-neutral-600 text-xs">Supports: PNG, JPEG, JPG, WEBP (5MB max)</p>
            </div>
          </div>
        </div>
      </Link>

      <p className="text-white font-semibold text-xl md:text-2xl mt-12 mb-4">Library</p>
      <Library />
    </div>
  );
};
