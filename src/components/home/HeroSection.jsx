      ...
      <div className="px-6 pt-6 lg:px-8">
        <nav className="flex items-center justify-between" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            <a href="https://github.com/binaryshrey/Bubbles" className="text-sm font-semibold leading-6 text-white">
              Github
            </a>
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                <div className="space-y-2 py-6">
                  <a href="https://github.com/binaryshrey/Bubbles" className="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-white">
                    Github
                  </a>
                  ...
                  <a href="https://in.linkedin.com/in/shreyanshsaurabh" className="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-white">
                    Contact
                  </a>
                </div>
                <div className="py-6">
        ...
        <div className="relative py-24 sm:py-32 lg:pb-40">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              <h1 className="text-4xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50 sm:text-6xl">
                Instantly Share & Celebrate
                <br />
                Your Magical Moments
              </h1>
              <p className="mt-6 text-lg leading-8 text-neutral-300">Via Bubble Links That Pops In A While</p>
            ...
            <div className="mt-16 flow-root sm:mt-24">
              <div className="-m-2 rounded-xl bg-slate-700 p-2 ring-1 ring-inset ring-slate-500/10 lg:-m-4 lg:rounded-2xl lg:p-4">
