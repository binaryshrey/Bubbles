  ...
  return (
    <div className="bg-black/[0.96] antialiased bg-grid-white/[0.02] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div data-aos="fade-up" data-aos-duration="500" className="mx-auto max-w-4xl sm:text-center">
      ...
      <div data-aos="fade-up" data-aos-duration="500" className="relative overflow-hidden pt-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
